...
static func get_max_level() -> int:
	return Config.get_config(GAME_LOG_SECTION, MAX_LEVEL, 0)

static func set_max_level(level_number : int) -> void:
	Config.set_config(GAME_LOG_SECTION, MAX_LEVEL, level_number)
