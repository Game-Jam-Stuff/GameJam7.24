...
@export var action_name_map : Dictionary = {
	GameContants.UserInputs.MOVE_UP : "Up",
	GameContants.UserInputs.MOVE_DOWN : "Down",
	GameContants.UserInputs.MOVE_LEFT : "Left",
	GameContants.UserInputs.MOVE_RIGHT : "Right",
	GameContants.UserInputs.JUMP : "Jump",
	GameContants.UserInputs.DASH : "Dash",
	GameContants.UserInputs.CROUCH : "Crouch",
	GameContants.UserInputs.INTERACT : "Interact",
	GameContants.UserInputs.SCREENSHOT : "Screenshot"
}
